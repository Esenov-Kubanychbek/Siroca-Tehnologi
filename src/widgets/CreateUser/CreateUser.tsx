        ...
        <div className={styles.CreateUser}>
            <div className={styles.Top}>
                <div className={styles.TextTop}>Создание пользователя</div>
                    <div onClick={modal.close} className={styles.Close}>
                        <CloseSquare size={34}/>
                    </div>
                </div>
            <div className={styles.Description}>
                <div className={styles.AddPhoto}>
                    <GalleryAdd size={50} color='rgba(37, 37, 37, 0.9)'/>
                    <div className={styles.Text2}>Добавьте фотографию пользователя</div>
                </div>
                <div>
                    <div>
                        <div className={styles.Text}>Фамилия имя</div>
                        <CustomInput width={324} placeholder='Напишите...'/>
                    </div>
            ...
            <div className={styles.Login}>
                <div>
                    ...
                    <CustomInput width={246} placeholder='@siroca.com'/>
                </div>                
                <div>
                    <div className={styles.Text}>Пароль</div>
                    <CustomInput width={246} placeholder='Напишите...'/>
                </div>
            </div>
            <div className={styles.Login}>
                <div>
                ...
                <div>
                    ...
                    <div className={styles.AddRole}>
                        <CustomInput width={184} placeholder='Напишите...'/>
                        <AddButton/>
                    </div>
                </div>  
            </div>
            <div className={styles.Buttons}>
                <div onClick={modal.close}><CustomButton variant='Secondary'width={150} text='Отменить'/></div>
                <div onClick={modal.close}><CustomButton variant='Primary' width={150} text='Создать'/></div>
            </div>
        </div>
    )
}
