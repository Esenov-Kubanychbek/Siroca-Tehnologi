        ...
        <div className={styles.DatesContainer}>
                    ...
                    <div className={styles.Dates}>
                        <div className={styles.Dates1}>
                            <Date variant="DateContainer" text="Дата начала:"/>
                            <Date variant="DateContainer" text="Срок выполнения:"/>
                            <Date variant="DateContainer" text="Дата отправки:"/>
                        </div>
                        <div className={styles.Dates2}>
                            <Date variant="DateContainer" text="Дата окончания::"/>
                            <Date variant="DateContainer" text="Дата подачи:"/>
                            <Date variant="DateContainer" text="Дата утверждения:"/>
                        </div>
                    </div>
