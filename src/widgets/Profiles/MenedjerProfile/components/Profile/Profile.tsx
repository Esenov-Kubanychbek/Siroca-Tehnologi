    ...
    return (
        <div className="Profile">
            ...
            <div className="block2">
                ...
                <InputProfile name="name" placeholder="" />
                <label htmlFor="lastName">Фамилия</label><br />
                <InputProfile name="lastName" placeholder="" />
                <label htmlFor="dol">Должность в компании</label><br />
                <InputProfile name="dol" placeholder="" />
                <label htmlFor="company">Компания</label><br />
                <InputProfile name="company" placeholder="" />
                <label htmlFor="login">Логин</label><br />
                <InputProfile name="login" placeholder="" />
