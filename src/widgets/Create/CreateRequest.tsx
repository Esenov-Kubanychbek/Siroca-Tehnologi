...
import { Input, CheckBox, MySelect, DataDiv, TextAreaReg, Button } from "../../shared/ui";
   ...
   return (
      <div className={styles.CreateReg}>
         ...
         <div className={styles.saved}>
            <Button variant={false} width="223px" text="Отменить"/>
            <Button variant={true} width="223px" text="Сохранить"/>
         </div>
      </div>
   );
};
