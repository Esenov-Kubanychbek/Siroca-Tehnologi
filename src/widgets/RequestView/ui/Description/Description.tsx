            ...
            >
                <div className={styles.container}>
                    <p className={styles.description}>
                        ...
                        спецификаций проекта. "Заявка выглядит полной и информативной. Хорошо представлены основные
                        детали и требования. Рекомендуется провести дополнительный анализ потребностей клиента.
                    </p>
