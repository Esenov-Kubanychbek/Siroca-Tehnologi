export const FolderAdd: any = () => {
   return (
      ...
      >
         <path
            d="M12.0596 17.25C11.6496 17.25 11.3096 16.91 11.3096 16.5V11.5C11.3096 11.09 11.6496 10.75 12.0596 10.75C12.4696 10.75 12.8096 11.09 12.8096 11.5V16.5C12.8096 16.91 12.4696 17.25 12.0596 17.25Z"
            fill="#5C5C5C"
         />
         <path
